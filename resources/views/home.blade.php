...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <nav>
    <h1>Welcome to our ebook Page</h1>
    <ul>
        <li><a href="/">Home</a></li>
  ...
  <p>Price: {{ $book->price }}</p>
    ...
    <footer>
      ...
      <div id="main">
        <p>Thank you for choosing our ebook. We hope it will help you learn and grow.</p>

        <p>If you have any questions or feedback, please don't hesitate to <a href="/contact">contact us</a>.</p>
